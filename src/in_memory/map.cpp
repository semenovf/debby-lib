...
#define BACKEND debby::backend::in_memory::map_st
#include "associative_container_impl.hpp"

#undef BACKEND
#define BACKEND debby::backend::in_memory::map_mt
#include "associative_container_impl.hpp"
...
template <>
map_st::rep_type map_st::make_kv (error * /*perr*/)
{
    return rep_type{true, native_type{}};
}

template <>
map_mt::rep_type map_mt::make_kv (error * /*perr*/)
{
    return rep_type{};
}
